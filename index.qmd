...
summary_data <- polling_place %>%
  summarize(
    ...
    Unique_jurisdictions = n_distinct(jurisdiction),
    Unique_jurisdiction_types = n_distinct(jurisdiction_type),
    Unique_location_types = n_distinct(location_type),
    Avg_polling_places_per_jurisdiction = mean(table(jurisdiction)),
    Avg_polling_places_per_county = mean(table(county_name)),
    Avg_polling_places_per_state = mean(table(state))
  )
